...
public class ScoringSystem {
    ...
    public static void printResultBoard(
        ...
        // check the match is the team type or not if then do the team score board
        // else do the individual score board;
        if (isTeamMatch) {
            System.out.printf(
            ...
            // loop the participants and get the winner team score
            ...
            // calculate the winner with the score list
